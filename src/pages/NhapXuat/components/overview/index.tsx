...
import { useGetAllPhieuNhapXuat } from '@/queries/admin.query';
...
export function OverViewTab() {
  ...
  const { data, isPending } = useGetAllPhieuNhapXuat();
  ...
  return (
    <>
      <div className="grid gap-6 rounded-md p-4 pt-0 ">
        <h1 className="text-center font-bold">DANH SÁCH NHẬP XUẤT</h1>
        {isPending ? (
          <div className="p-5">
            <DataTableSkeleton
              columnCount={10}
